...
<section class="checkout spad">
    <div class="container">
        <form action="${contextPath }/admin/salesData/MemberAnalysis_thisYear" method="post" class="checkout__form" >
            <div class="row">
                <div class="col-lg-8">
                    <h5>올해 회원분석</h5>
          ...
          <thead>
            <tr>             
              ...
              <th scope="col">이탈회원 비율</th>                        
                            		...
                            		<c:forEach var="SalesData"  items="${MemberAnalysis_thisyear_Monthly }">
		                            		 <tr>
		                            		 	<td>${SalesData.registermonth } </td>                		 
