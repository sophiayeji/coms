...
<section class="checkout spad">
    <div class="container">
        <form action="${contextPath }/admin/venueRent/approve" method="post" class="checkout__form" >
            <div class="row">
                <div class="col-lg-8">
                    <h5>대관신청 승인</h5>
							...
							<div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                	<c:forEach var="venueRentDTO" items="${venueRentList }">
                                                    <tr>
                                                        <td class="px-4 border-top">
                                                             <c:set var="startBoardIdx" value="${startBoardIdx = startBoardIdx + 1}"/>
                                                                ${startBoardIdx}</td>                                                       
                                                        <td class="px-4 border-top"><a href="${contextPath }/admin/venueRent/detail?uuid=${venueRentDTO.uuid }">${venueRentDTO.uuid}</a></td>
                                                        <td class="px-4 border-top">${venueRentDTO.numUse}</td>
                                                        <td class="px-4 border-top">${venueRentDTO.rentDt}</td>
                                                        <td class="px-4 border-top">${venueRentDTO.rentT}시</td>
